...
const (
	GENL_NETDEV_VERSION = 1
	GENL_NETDEV_NAME    = "netdev"
)

const (
	GENL_NETDEV_ATTR_QUEUE_PAIR_UNSPEC = iota
	GENL_NETDEV_ATTR_QUEUE_PAIR_QUEUE_TYPE
	GENL_NETDEV_ATTR_QUEUE_PAIR_SRC_IFINDEX
	GENL_NETDEV_ATTR_QUEUE_PAIR_SRC_QUEUE_ID
	GENL_NETDEV_ATTR_QUEUE_PAIR_DST_IFINDEX
	GENL_NETDEV_ATTR_QUEUE_PAIR_DST_QUEUE_ID
)

const (
	GENL_NETDEV_CMD_UNSPEC = iota
	GENL_NETDEV_CMD_DEV_GET
	GENL_NETDEV_CMD_DEV_ADD_NTF
	GENL_NETDEV_CMD_DEV_DEL_NTF
	GENL_NETDEV_CMD_DEV_CHANGE_NTF
	GENL_NETDEV_CMD_PAGE_POOL_GET
	GENL_NETDEV_CMD_PAGE_POOL_ADD_NTF
	GENL_NETDEV_CMD_PAGE_POOL_DEL_NTF
	GENL_NETDEV_CMD_PAGE_POOL_CHANGE_NTF
	GENL_NETDEV_CMD_PAGE_POOL_STATS_GET
	GENL_NETDEV_CMD_QUEUE_GET
	GENL_NETDEV_CMD_NAPI_GET
	GENL_NETDEV_CMD_QSTATS_GET
	GENL_NETDEV_CMD_BIND_RX
	GENL_NETDEV_CMD_NAPI_SET
	GENL_NETDEV_CMD_BIND_TX
	GENL_NETDEV_CMD_BIND_QUEUE
)
